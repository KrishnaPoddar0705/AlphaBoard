                                        ...
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-2">
                                                <span className="text-lg font-mono font-bold text-[#1C1B17] tabular-nums">
                                                    {getCurrencySymbol(ticker)}{target.target_price.toLocaleString(ticker.includes('.NS') || ticker.includes('.BO') ? 'en-IN' : 'en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                                                </span>
